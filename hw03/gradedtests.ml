...
let size_ty_tests =
  ...
  ; ( "ty_size6"
    , assert_eqf (fun () -> size_ty [] (Struct [I64; I1; Ptr I8; Ptr I64; Array (10, I1)])) 112 )
  ; ( "ty size7"
    , assert_eqf
        (fun () -> size_ty [("O", I1); ("S", I64)] (Struct [Namedt "O"; Array (2, Namedt "S")]))
        24 ) ]
...
let memory_tests =
  [("llprograms/alloca1.ll", 17L); ("llprograms/alloca2.ll", 17L); ("llprograms/global1.ll", 12L)]
...
let bitcast_tests = [("llprograms/bitcast1.ll", 3L)]
...
let io_tests =
  ...
  ; ("llprograms/args1.ll", ["hello"; "cos320"], "hellocos320")
  ; ("llprograms/args1.ll", ["hello"; "cos320"; "foo"], "argc > 3") ]
...
let manual_tests : suite =
  [GradedTest ("Posted Piazza Test Case", 5, []); GradedTest ("Other Student Piazza Tests", 5, [])]
