...
let block_flow_forwards_map (fi : uid * insn -> 'd -> 'd) (ft : terminator -> 'd -> 'd)
    ({insns; term} : block) (d_in : 'd)
    : uid -> 'd
  =
  let t_id, t = term in
  let m, d_tmn =
...
let block_flow_backwards_map (fi : uid * insn -> 'd -> 'd) (ft : terminator -> 'd -> 'd)
    ({insns; term} : block) (d_out : 'd)
    : uid -> 'd
  =
  let t_id, t = term in
