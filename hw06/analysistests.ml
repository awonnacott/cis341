...
let liveness_analysis_tests =
  ...
  ; ( "llprograms/analysis4.ll"
    , lblm [("_entry", uids ["argc"]); ("l1", uids ["2"; "3"]); ("l2", uids ["3"])] )
  ...
  ; ( "llprograms/analysis2.ll"
    , lblm [("_entry", uids ["argc"]); ("l1", uids ["1"; "3"]); ("l2", uids [])] )
  ; ("llprograms/analysis19.ll", lblm [("_entry", uids [])])
  ; ( "llprograms/analysis18.ll"
    , lblm [("_entry", uids []); ("bar", uids ["1"; "2"; "3"; "4"]); ("foo", uids ["1"; "sa"])] )
  ...
  ; ( "llprograms/analysis10.ll"
    , lblm
        ...
        ; ("merge", uids ["1"; "7"])
        ; ("then", uids ["1"; "7"]) ] )
  ; ("llprograms/analysis1.ll", lblm [("_entry", uids ["argc"]); ("l1", uids ["1"; "3"])]) ]
...
let alias_analysis_tests =
  ...
  ; ("llprograms/analysis8.ll", lblm [("_entry", uidm [("argv", MayAlias); ("tmp1", Unique)])])
  ; ( "llprograms/analysis7.ll"
    , lblm
  ...
  ; ( "llprograms/analysis19.ll"
    , lblm [("_entry", uidm [("1", Unique); ("2", MayAlias); ("arcv", MayAlias)])] )
  ; ( "llprograms/analysis18.ll"
    , lblm
        [ ("_entry", uidm [("1", Unique); ("arcv", MayAlias)])
        ; ( "bar"
          , uidm [("1", Unique); ("arcv", MayAlias); ("sa", Unique); ("sb", Unique); ("sc", Unique)]
          )
        ; ( "foo"
          , uidm [("1", Unique); ("arcv", MayAlias); ("sa", Unique); ("sb", Unique); ("sc", Unique)]
          ) ] )
  ...
  ; ( "llprograms/analysis14.ll"
    , lblm [("_entry", uidm [("1", MayAlias); ("2", MayAlias); ("arcv", MayAlias)])] )
  ; ( "llprograms/analysis13.ll"
    , lblm
        [ ("_entry", uidm [("arcv", MayAlias)])
  ...
  ; ("llprograms/analysis12.ll", lblm [("_entry", uidm [("arcv", MayAlias)])])
  ; ( "llprograms/analysis11.ll"
    , lblm [("_entry", uidm [("argv", MayAlias)]); ("foo", uidm [("4", Unique); ("5", Unique)])] )
  ; ( "llprograms/analysis10.ll"
    , lblm
...
let constprop_analysis_tests =
  ...
  ; ( "llprograms/analysis16.ll"
    , lblm
        [ ( "_entry"
          , uidm [("1", NonConst); ("2", NonConst); ("arcv", NonConst); ("argc", NonConst)] )
        ; ( "continue_loop"
          , uidm
              [ ("1", NonConst)
              ; ("10", NonConst)
