...
let print_live args (cfg : Cfg.t) : string = Liveness.Graph.to_string @@ Liveness.analyze cfg

let print_cp args (cfg : Cfg.t) : string = Constprop.Graph.to_string @@ Constprop.analyze cfg

let print_alias args (cfg : Cfg.t) : string = Alias.Graph.to_string @@ Alias.analyze cfg
